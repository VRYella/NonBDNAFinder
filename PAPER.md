...
4. **Export and visualisation** — Results exported as CSV/XLSX/BED-ready tabular files and rendered as publication-quality stacked bar charts, motif maps, and class-distribution plots via Matplotlib/Seaborn.
