...
*Correspondence:* [yvrajesh_bt@kluniversity.in](mailto:yvrajesh_bt@kluniversity.in) (V.R.Y.); [aditya@tezu.ernet.in](mailto:aditya@tezu.ernet.in) (A.K.)  
ORCID: V.R.Y. [0000-0002-1961-5051](https://orcid.org/0000-0002-1961-5051); A.K. [0000-0002-6474-8830](https://orcid.org/0000-0002-6474-8830)

---

## Abstract

Non-canonical DNA secondary structures arise from sequence-encoded alternative conformations within genomic contexts and contribute to gene regulation, replication control, genome instability, and disease pathogenesis. Despite substantial evidence that a broad repertoire of non-B DNA conformations are physiologically relevant, existing computational tools do not capture the full structural diversity or provide cross-class contextual analysis. Here we present **Non-B DNA Finder (NonBDNAFinder)**, a modular Python framework for high-throughput detection of **11 classes** and **24 subclasses** of non-B DNA motifs—Curved DNA (global and local), Slipped DNA (direct repeats and STRs), Cruciform, R-Loop, Triplex (H-DNA and Sticky DNA), G-Quadruplex (eight subclasses including telomeric, stacked, canonical, bulged, higher-order arrays, extended-loop, G-triplex, and two-tetrad weak PQS), i-Motif (canonical, relaxed, and AC-motif), Z-DNA (canonical and eGZ), A-philic DNA, Hybrid overlaps, and Non-B DNA Clusters. A-philic DNA scoring employs a novel 10-mer log-odds table derived from A-form and B-form DNA entries in the Nucleic Acid Knowledgebase (NAKB), and Z-DNA detection is grounded in a ZSeeker-based 10-mer propensity scoring framework. Each motif call is annotated with genomic coordinates, strand, subclass label, and a literature-anchored normalised confidence score on a 1–3 scale. Post-processing resolves cross-class overlaps, consolidates hybrid loci, and identifies multi-class structural hotspot clusters. Application across twelve diverse genomes—eight bacterial species spanning 17.6–76.2% GC content, *Saccharomyces cerevisiae*, *Plasmodium falciparum*, and *Homo sapiens* (full genome and centromere assembly)—identified 14.97 million primary non-B DNA motifs, demonstrating strong GC-composition-dependent structural diversification. Tool performance was validated using experimentally characterised loci and by benchmarking against nBMST, G4Hunter, ZSeeker, and QmRLFS-finder. Non-B DNA Finder is freely available at [https://github.com/VRYella/NonBDNAFinder](https://github.com/VRYella/NonBDNAFinder) under the MIT licence and as a web application at [https://nonbdnafinder.streamlit.app/](https://nonbdnafinder.streamlit.app/).

**Keywords:** non-B DNA; G-quadruplex; Z-DNA; R-loop; i-motif; cruciform DNA; triplex DNA; A-philic DNA; genome instability; structural genomics; computational tool

---

## 1. Introduction

Watson and Crick's 1953 model of the DNA double helix established the B-form right-handed helix as the canonical conformation of the genome¹. Decades of subsequent research have demonstrated, however, that genomic DNA is structurally versatile, adopting a rich repertoire of alternative secondary structures under physiological conditions²⁻⁵. The first major departure from canonical duplex geometry was Z-DNA, a left-handed helical form characterised crystallographically by Wang *et al.* in 1979⁶. In 1980, Lilley demonstrated cruciform extrusion from palindromic inverted repeats in supercoiled plasmids¹⁵. Around the same time, intrinsically curved DNA mediated by phased A-tracts was characterised in kinetoplast DNA and nucleosome core particles¹⁸, and mirror-repeat–based triplex H-DNA structures were experimentally identified in the mid-1980s¹³.

Attention then turned to guanine-rich sequences. Telomeric G-quadruplexes were described electrophoretically by Sen and Gilbert in 1988 as four-stranded complexes stabilised by Hoogsteen hydrogen bonds⁵⁰; in vitro characterisation proceeded through the 1990s, and in vivo mapping using G4-specific antibodies and bioinformatics analyses followed in the 2000s. The i-motif, a cytosine-intercalated four-stranded counterpart of the G4, was introduced by Gehring *et al.* in 1993³⁵ and confirmed in living cell nuclei by Zeraati *et al.* in 2018¹¹. The importance of R-loops, co-transcriptional RNA:DNA hybrid structures, was established through DRIP-seq and related genome-wide approaches in the 2000s–2010s⁹.

More recently, the structural repertoire has expanded to include G-triplex intermediates—folding intermediates in the G-quadruplex assembly pathway⁵¹—AC-motifs formed by alternating adenine–cytosine tracts with roles in transcriptional regulation⁵³, and extruded-guanine Z-DNA (eGZ) arising from CGG trinucleotide repeat expansions associated with neurological disease⁵². Together, these discoveries underscore that non-B DNA is not an exotic curiosity but a pervasive and functionally significant feature of genome architecture.

Collectively termed *non-B DNA* (or non-canonical DNA), these structures include left-handed Z-helices, intramolecular triplexes (H-DNA), G-quadruplexes (G4), cytosine-intercalated i-motifs, R-loops (RNA:DNA hybrids), cruciform extrusion products of inverted repeats, and intrinsically curved or A-philic (narrow minor-groove) sequences. Each class has a distinct structural grammar determined by local nucleotide composition and sequence context, and each exerts profound effects on fundamental cellular processes.
...
A number of bioinformatics tools have been developed for individual non-B DNA classes: **G4Hunter**²⁰ and **pqsfinder**²¹ for G-quadruplexes; **QmRLFS-finder**²² for R-loops; **Non-B DB** and the **non-B DNA Motif Search Tool (nBMST)**²³ for a broad but web-limited catalogue; **ZHUNT**²⁴ and the more recent **ZSeeker**⁵⁴ for Z-DNA; and **Triplexator**⁵⁵ for triplex detection. However, several critical gaps remain:
...
4. **Absent emerging motifs:** Tools such as nBMST and Non-B DB do not annotate G-triplexes, AC-motifs, Sticky DNA, or eGZ variants.
5. **No cross-class analysis:** Hybrid loci where two or more classes co-occur, and multi-class hotspot clusters, are invisible to single-class tools.
6. **Scalability:** Web-based tools restrict input size; many published tools lack genome-scale throughput.
7. **Reproducibility:** Scoring parameters are often undocumented or opaque.

NonBDNAFinder addresses all seven gaps in a single open-source package. Specifically, this study was designed to answer three key questions: (i) How broadly are canonical and newly described non-B DNA motifs distributed across genomes spanning a wide range of GC content? (ii) To what extent do distinct structural motifs overlap or form hotspot clusters within the same genomic loci? (iii) How does sequence composition influence structural diversity and complexity across different organisms?
...
Z-DNA–prone regions are identified using a 10-mer propensity scoring framework derived from the **ZSeeker** algorithm of Wang *et al.*⁵⁴, which evaluates the Z-helical conformational potential of each dinucleotide step. Specifically, a scoring table of 107 distinct 10-mers was constructed using the ZSeeker propensity framework, excluding 10-mers that contain TA dinucleotide steps—which are known to destabilise Z-DNA⁶—to ensure stringent and specific prediction of Z-forming regions. Adjacent high-scoring 10-mers are merged by a sliding-window scan, and the longest contiguous Z-DNA segment is retained per locus. eGZ (extruded-guanine Z-DNA) motifs are detected as runs of ≥4 trinucleotide repeats from the set {CGG, GGC, CCG, GCC}, following Fakharzadeh *et al.*⁵², with log-linear normalisation to accommodate the wide dynamic range of cumulative scores. eGZ repeat tracts exceeding known clinical expansion thresholds are flagged for their association with CGG-repeat–linked neurological disorders. Optional Hyperscan multi-pattern matching accelerates 10-mer scanning when available. Two subclasses are reported: *Z-DNA* and *eGZ*.
...
#### Table 3. Nine-Genome Bacterial Diversity Overview {#table-3}

| Genome | Size (bp) | Organism Type | GC% | Motifs | Density (motifs/kb) | Diversity Index *H* |
|--------|-----------|---------------|-----|--------|---------------------|---------------------|
| *Buchnera aphidicola* | 452,078 | Bacterial endosymbiont | 18.3 | 4,690 | 10.37 | 0.140 |
| *Candidatus* Carsonella ruddii | 174,014 | Bacterial endosymbiont | 17.6 | 1,791 | 10.29 | 0.113 |
| *Staphylococcus aureus* | 2,821,361 | Gram-positive bacterium | 32.9 | 2,982 | 1.06 | 1.027 |
| *Streptococcus pneumoniae* | 2,110,968 | Gram-positive bacterium | 39.7 | 3,011 | 1.43 | 1.310 |
| *Escherichia coli* K-12 | 4,641,652 | Gram-negative bacterium | 50.8 | 10,622 | 2.29 | 1.681 |
| *Mycobacterium tuberculosis* | 4,411,532 | High-GC Actinobacterium | 65.6 | 29,638 | 6.72 | 1.446 |
| *Cellulomonas shaoxiangyii* | 3,909,366 | Actinobacterium | 75.3 | 41,758 | 10.68 | 1.669 |
| *Miltoncostaea marina* | 3,370,274 | Actinobacterium | 76.2 | 43,297 | 12.85 | 1.677 |
| *Saccharomyces cerevisiae* | 12,157,105 | Eukaryotic yeast | 38.2 | 24,950 | 2.05 | 1.442 |
| **Total / Average** | **38,048,350** | **9 genomes** | — | **162,739** | **6.42 (avg)** | — |

Notably, *M. tuberculosis* (GC 65.6%) exhibits G-quadruplex predominance and R-loop enrichment consistent with other high-GC organisms. STRs account for 32% of slipped DNA motifs in *M. tuberculosis*—a higher fraction than any other organism in the panel—potentially reflecting lineage-specific constraints on repeat instability related to the pathogen's slow-growth lifestyle and high-GC codon usage. *S. aureus* displays the lowest motif density and diversity across all tested genomes (density 1.06/kb, *H* = 1.027), suggesting a relatively streamlined structural landscape despite retaining representatives of all major motif classes. The extreme-GC organisms *C. shaoxiangyii* and *M. marina* exhibit both the highest density (10.68–12.85/kb) and near-maximal diversity (*H* ≈ 1.67), confirming that GC-rich genomes simultaneously maximise non-B DNA abundance and compositional breadth.
...
#### Table 4. Feature Comparison: Non-B DNA Finder vs. Selected Existing Tools {#table-4}

| Feature / Class | Non-B DNA Finder | nBMST | G4Hunter | ZSeeker | QmRLFS-finder | Non-B DB |
|-----------------|:----------------:|:-----:|:--------:|:-------:|:-------------:|:--------:|
...
| Mirror repeats | ✓ | ✓ | ✗ | ✗ | ✗ | ✓ |
| A-philic (NAKB-based) | ✓ | ✗ | ✗ | ✗ | ✗ | ✗ |
| Non-canonical G4 subtypes | ✓ (8 subclasses) | ✗ | ✗ | ✗ | ✗ | ✗ |
| G-triplex intermediates | ✓ | ✗ | ✗ | ✗ | ✗ | ✗ |
| AC-motif (i-motif variant) | ✓ | ✗ | ✗ | ✗ | ✗ | ✗ |
| Hybrid / cross-class overlap | ✓ | ✗ | ✗ | ✗ | ✗ | ✗ |
| Non-B DNA cluster detection | ✓ | ✗ | ✗ | ✗ | ✗ | ✗ |
| Genome-scale batch processing | ✓ | ✓ | ✓ | ✓ | ✓ | Pre-computed |
...
We thank the developers of G4Hunter, QmRLFS-finder, ZSeeker, ZHUNT, Non-B DB, and nBMST for their foundational contributions to the non-B DNA computational landscape. We acknowledge the BioPython, NumPy, pandas, Matplotlib, and Streamlit open-source communities. We thank the NAKB (Nucleic Acid Knowledgebase) team for making A-form and B-form DNA structural data publicly accessible. Parts of the software implementation and interface development were assisted by the AI-based programming tool GitHub Copilot; all algorithmic design and scientific validation were performed by the authors.

---

## Author Contributions

V.R.Y. conceived the project, designed the algorithmic framework, implemented the detector suite, and wrote the manuscript. A.S.C.G. contributed to algorithm implementation, testing, and manuscript revision. A.K. contributed to algorithm design, biological interpretation, and manuscript revision. All authors reviewed and approved the final manuscript.
...
36. Hur, J. H. *et al.* AC-motif: a DNA motif containing adenine and cytosine repeat plays a role in gene regulation. *Nucleic Acids Res.* **49**, 10150–10165 (2021).
...
50. Sen, D. & Gilbert, W. Formation of parallel four-stranded complexes by guanine-rich motifs in DNA and its implications for meiosis. *Nature* **334**, 364–366 (1988).
51. Hou, X. M. *et al.* Involvement of G-triplex and G-hairpin in the multi-pathway folding of human telomeric G-quadruplex. *Nucleic Acids Res.* **45**, 11401–11412 (2017).
52. Fakharzadeh, A., Zhang, J., Roland, C. & Sagui, C. Novel eGZ-motif formed by regularly extruded guanine bases in a left-handed Z-DNA helix as a major motif behind CGG trinucleotide repeats. *Nucleic Acids Res.* **50**, 4860–4876 (2022).
53. Hur, J. H. *et al.* AC-motif: a DNA motif containing adenine and cytosine repeat plays a role in gene regulation. *Nucleic Acids Res.* **49**, 10150–10165 (2021).
54. Wang, G. *et al.* ZSeeker: an optimised algorithm for Z-DNA detection in genomic sequences. *Briefings Bioinform.* **26**, bbaf240 (2025).
55. Buske, F. A., Bauer, D. C., Mattick, J. S. & Bailey, T. L. Triplexator: detecting nucleic acid triple helices in genomic and transcriptomic data. *Genome Res.* **22**, 1372–1381 (2012).
56. Berman, H. M. *et al.* The Nucleic Acid Knowledgebase (NAKB): structure, data and tools. *Nucleic Acids Res.* **52**, D245–D254 (2024).
