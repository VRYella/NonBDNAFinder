...
# ═══════════════════════════════════════════════════════════════════════════════
PAGE_HEADING_COLORS = {
    'Home': {'primary': '#DC2626', 'border': '#fca5a5', 'pattern': 'linear-gradient(135deg, #B91C1C 0%, #DC2626 40%, #EF4444 75%, #FCA5A5 100%)'},
    ...
    'Documentation': {'primary': '#EA580C', 'border': '#FDBA74', 'pattern': 'linear-gradient(135deg, #9A3412 0%, #EA580C 40%, #FB923C 75%, #FBBF24 100%)'},
}
