...
def _build_motif_class_card(info):
    ...
    return f"<div style='padding:0.3rem 0.6rem;background:{s['background']};border-radius:10px;border-left:4px solid {s['border']};border-top:1px solid rgba(255,255,255,0.6);box-shadow:0 3px 12px rgba(0,0,0,0.08),0 0 8px rgba(0,0,0,0.04);transition:all 0.2s ease;'><div style='font-weight:700;color:{s['text']};font-size:0.87rem;line-height:1.3;'>{info['num']}. {info['name']}</div><div style='color:{s['text']};font-size:0.79rem;margin-top:0.05rem;line-height:1.2;opacity:0.85;'>{info['subtitle']}</div></div>"
