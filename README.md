...
- **📊 Excel-Based Pattern Loading**: Primary pattern source is now Excel (`patterns.excel` with 170K+ patterns and normalized scores 1-3) for easy editing, with automatic JSON fallback (see [EXCEL_PATTERN_GUIDE.md](EXCEL_PATTERN_GUIDE.md))
...
- `patterns.excel` - **PRIMARY SOURCE** - Excel file with 170,008+ pattern definitions with normalized scores (user-editable)
